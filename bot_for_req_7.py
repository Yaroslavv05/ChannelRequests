...
conn = sqlite3.connect('user_database7 .db')
cursor = conn.cursor()
...
bot = Bot(token='6949601047:AAHIailrBWGbhiMp2Mpllg_TFXw42Tan4uM')
storage = MemoryStorage()
CHANNEL_ID = -1002114687786
...
async def on_chat_join_request(update: types.ChatJoinRequest):
    ...
    await bot.send_message(update.from_user.id, f'<b>Hi {update.from_user.full_name}!🤝 Your application to the channel is approved✅</b>\n\n👨‍💻 My name is Mike, I run a blog about making money from cryptocurrency. In my channel I give private instructions and guides.\n\n<b>💸 This is an important business for me, so we work for % of net profit, but only after you earn!</b>\n\n🏆 Write me a "+" in a PM for detailed information.\n\n<b>My Telegram for communication - @mthompson_crypto</b>', parse_mode='HTML')
